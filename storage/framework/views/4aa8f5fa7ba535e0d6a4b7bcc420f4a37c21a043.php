          ...
          <div class="card rounded-lg shadow">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea name="motivo" id="motivoAdopcion" class="form-control <?php $__errorArgs = ['motivo'];
...
unset($__errorArgs, $__bag); ?>" required rows="3" autofocus></textarea>
          ...
          <div class="card rounded-lg shadow">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="telefono_dueno" id="telefono_dueno" class="form-control  <?php $__errorArgs = ['telefono_dueno'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(Auth::user()->telefono); ?>" required autofocus>
          ...
          <div class="card rounded-lg shadow">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="nombre_perro" id="nombre_perro" class="form-control  <?php $__errorArgs = ['nombre_perro'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="" required autofocus>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <textarea name="descripcion_color" id="descripcion_color" rows="3" class="form-control <?php $__errorArgs = ['motivo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required autofocus></textarea>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <input type="number" name="edad" id="edad" class="form-control  <?php $__errorArgs = ['edad'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required autofocus min="1" max="360">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="row form-group justify-content-center">
                    <div class="form-check form-check-inline">
                        <input type="checkbox" name="esterilizado" id="esterilizado" class="form-control form-check-input <?php $__errorArgs = ['esterilizado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" autofocus>
                    ...
                    <div class="form-check form-check-inline">
                        <input type="checkbox" name="desparacitado" id="desparacitado" class="form-control form-check-input <?php $__errorArgs = ['desparacitado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" autofocus>
                    ...
                    <div class="form-check form-check-inline">
                        <input type="checkbox" name="vacunado" id="vacunado" class="form-control form-check-input <?php $__errorArgs = ['vacunado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" autofocus>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <div class="form-check form-check-inline">
                      <input type="radio" name="genero" id="genero_m" class="form-check-input form-control <?php $__errorArgs = ['genero'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="Macho" required autofocus checked>
                      <label class="form-check-label" for="genero_m">
                        Macho
                      </label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input type="radio" name="genero" id="genero_h" class="form-check-input form-control <?php $__errorArgs = ['genero'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="Hembra" required autofocus>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <textarea name="otros_detalles" id="otros-detalles" class="form-control <?php $__errorArgs = ['otros_detalles'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <textarea name="comportamiento" id="comportamiento" class="form-control <?php $__errorArgs = ['comportamiento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <div class="custom-file">
                          <input type="file" name="imagen_perro" id="imagen-perro" class="custon-file-input <?php $__errorArgs = ['comportamiento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
